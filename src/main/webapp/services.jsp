...
<section class="w-full px-8 text-gray-700 bg-white">
    ...
    <div class="max-w-2xl mx-auto mt-24 gap-5">
     ...
     <%
			        	...
			        	%>
    <div class="flex gap-3 bg-white border border-gray-300 mb-10 rounded-xl overflow-hidden items-center justify-start">

        <div class="relative w-32 h-32 flex-shrink-0">
            <img class="absolute left-0 top-0 w-full h-full object-cover object-center transition duration-50" loading="lazy" src="<%=services.getImage() %>">
        </div>

        <div class="flex flex-col gap-2 py-2">

            <p class="text-xl font-bold"><%=services.getName() %></p>
            ...
            <span class="flex items-center justify-start text-gray-500">
                ...
                <a href="amitpachange.com" target="_blank"><%=services.getPrice() %></a>
            </span>
