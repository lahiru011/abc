<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%@ page import = "com.reserve.model.ReserveModel" %>
                ...
                <table class="min-w-full">
                    ...
                    <tbody>
			            <%
			        		...
			        		ArrayList<ReserveModel> ReserveList = Interface.getReserves();
				
			        	%>
			        	
			        	
			        	<%
			        		for(ReserveModel services: ReserveList){
			        	%>
                        <tr class="border-b">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap"><%= services.getPhone() %></td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap"><%= services.getEmail() %></td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap"><%= services.getDate() %></td>
                            <td>
                            	<div>
			          				<form action="<%= request.getContextPath()%>/DeleteReserve" method="post">
